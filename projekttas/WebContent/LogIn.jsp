			...
			<div class='row'>
				<div class='col-md-6'>
					<form action='url_do_logowania' method='post'>
						...
						<div class="checkbox">
							<label>
								<input type="checkbox" value="remeber-me">Zapamiętaj mnie 
							</label>
						</div>
				...
				<div class='col-md-6'>
					<h3>Nie masz jeszcze konta? Załóż je teraz!</h3></br>
					<a href="SignUp.jsp" class="btn btn-info" role="button">Rejestracja</a>
				</div>
			</div>
			<hr>
			<footer>
